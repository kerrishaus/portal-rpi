	...
	if "-install" in sys.argv:
		...
		subprocess.run('''
...

			{
				...
				echo "ExecStart=chromium-browser --noerrdialogs --disable-infobars --disable-error-bubbles --ignore-certificate-errors --check-for-update-interval=31536000 --autoplay-policy=no-user-gesture-required --kiosk /home/pi/index.html"
				echo ""
				echo "[Install]"
				echo "WantedBy=multi-user.target"
			} > portal-gui.service
